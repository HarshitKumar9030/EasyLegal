...
import { Menu, X, Home, Briefcase, MessageSquare, FileText, Scale, ShieldAlert, HelpCircle } from "lucide-react";
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              className="fixed top-0 left-0 h-[100dvh] w-72 bg-[#0a0a0a] border-r border-white/10 z-50 flex flex-col shadow-2xl"
            >
